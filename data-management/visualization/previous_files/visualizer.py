...
fx = fy = 1000
cx, cy = 960, 540
male_body_model = smplx.create(r'C:\Users\12595\Desktop\MTA\python\visualization',
                               model_type='smplx',
                               gender='male',
                               num_betas=10)
female_body_model = smplx.create(r'C:\Users\12595\Desktop\MTA\python\visualization',
                                 model_type='smplx',
                                 gender='female',
                                 num_betas=10)
neutral_body_model = smplx.create(r'C:\Users\12595\Desktop\MTA\python\visualization',
                                  model_type='smplx',
                                  gender='neutral',
                                  num_betas=10)
cam_poses = np.array([
