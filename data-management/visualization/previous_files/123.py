...
def concat_video(overlay_dir, dst):
    for seq in os.listdir(overlay_dir):
        ...
        # cmd = (f'cd {img} && ffmpeg.exe -y -r {RECORD_FPS} -f image2 -s 1920x1080 -i "*.jpeg" '
               f'-vcodec libx264 -crf 25 -pix_fmt yuv420p {dst}\\{seq}_smplx.mp4'
               )
        # call(cmd, shell=True)
        os.system(cmd)
...
if __name__ == '__main__':
    ...
    img_dir_path = r'C:\Users\12595\Desktop\GTA-test-data\mta-for-vis'
    pkl_dir_path = r'C:\Users\12595\Desktop\GTA-test-data\smplx_fitting_0'
    overlay_out_path = r'C:\Users\12595\Desktop\GTA-test-data\smplx-overlay'
    video_destination = r'C:\Users\12595\Desktop\GTA-test-data\vids-smplx'
